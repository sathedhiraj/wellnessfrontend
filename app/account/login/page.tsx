  ...
  return (
    <section className="section-py bg-cream-50 min-h-[70vh] flex items-center">
      <div className="container-padded max-w-md w-full mx-auto">
        <Suspense fallback={
          <div className="bg-white rounded-3xl shadow-card p-8 text-center flex flex-col items-center gap-4">
            <div className="w-12 h-12 border-4 border-sage-200 border-t-forest rounded-full animate-spin" />
            <p className="text-warmgray-400 text-sm">Loading login form...</p>
          </div>
        }>
          <LoginForm />
        </Suspense>
